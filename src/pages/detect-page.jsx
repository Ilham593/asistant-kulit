  ...
  return (
    <>
      <div className="min-h-screen bg-[#fefaf6] py-8 px-4">
        ...
        <section className="container mx-auto max-w-3xl p-4 md:p-8 border rounded-lg space-y-4">
          <div className="text-gray-700 bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded">
            <ul className="pl-2 space-y-3">
              ...
              <li>
                Pastikan foto yang diupload terang dan jelas untuk hasil deteksi
                yang akurat.
              </li>
            </ul>
          </div>
        ...
        {result && (
          <section
            className="my-6 container mx-auto max-w-3xl p-6 bg-white rounded-lg shadow space-y-6"
          ...
          >
            ...
            <div className="mb-6 p-4 bg-yellow-50 border-l-4 border-yellow-400 text-gray-950 rounded-lg italic">
              ...
              referensi awal. assistantSkin membantu memahami kondisi kulit Anda
              dan bukan pengganti Dokter. Untuk diagnosis dan penanganan yang
              tepat, konsultasikan dengan dokter spesialis kulit.
            </div>
              ...
              <div className="mt-4 p-4 border rounded-lg">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {result.recommendations.map((item) => (
                    <div
                      key={item.id}
                      className="flex border rounded-lg overflow-hidden space-y-4"
                    >
                      <img
                        src={item.image}
                        alt={item.name}
